...
import com.application.common.constants.AuthoritiesConstants;
...
public class RemoteUserNamePasswordAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    protected UserDetails retrieveUser(String username,
        ...
        // todo 需要重新校验此处用户名和消息
        return new User(username, (String) authentication.getCredentials(), Collections.singletonList(() -> AuthoritiesConstants.USER));
    }
