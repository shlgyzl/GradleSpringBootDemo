package com.application.jpa.filter.config;

import com.application.jpa.filter.filters.CachingHttpHeadersFilter;
import com.application.jpa.filter.filters.ShallowEtagHeaderAdvanceFilter;
